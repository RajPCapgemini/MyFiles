...
public class TransactionProjection {
	...
	@QueryHandler
	public List<Transaction> handleGetTransactionBetweenDatesQuery(GetTransactionBetweenDatesQuery query){
		return repo.findByAccountNoAndTransactionDateBetweenOrderByTransactionDateDesc(query.getAccountNo(),query.getStartDate(),query.getEndDate());
	}
