...
public class AccountCommnadController {
	...
	public ResponseEntity<List<AccountDTO>> fundTransfer(@RequestBody FundTransferDTO request) throws AccountDetailsNotFoundException, HighValueTransactionException, NegativeAmountException, InsufficientFundsException, BankServerDownException{
