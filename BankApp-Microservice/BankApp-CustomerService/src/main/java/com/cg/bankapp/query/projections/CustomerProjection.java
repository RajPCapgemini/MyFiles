...
public class CustomerProjection {
	...
	public Customer handelGetCustomerQuery(GetCustomerByIdQuery getCustomerByIdQuery) throws CustomerDetailsNotFoundException {
		return customerDAO.findById(getCustomerByIdQuery.getId()).orElseThrow(()->new CustomerDetailsNotFoundException("Customer Details Not found for Id 14 april :-  "+getCustomerByIdQuery.getId()));
	}
}