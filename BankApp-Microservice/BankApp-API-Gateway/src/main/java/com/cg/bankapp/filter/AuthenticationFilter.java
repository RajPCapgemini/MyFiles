...
import com.cg.bankapp.entities.Authorities;
import com.cg.bankapp.entities.ConnValidationResponse;
import com.cg.bankapp.entities.ExceptionResponseModel;
...
public class AuthenticationFilter extends AbstractGatewayFilterFactory<AuthenticationFilter.Config> {
    ...
    List<String> excludedUrls = new ArrayList<>(List.of("/auth/add", "/auth/login", "/customer/addCustomerDetails"));
        ...
        return (exchange, chain) -> {
            ...
            if(isSecured.test(request)) {
                ...
                return webClientBuilder.build().get()
                        .uri("http://localhost:9012/auth/validate")
